...
const ApartmentList = (params: IApartmentListParams) => {
                            ...
                            <div id={'collapse-'+apartment.id} className="accordion-collapse collapse" aria-labelledby={'#header-'+apartment.id} data-bs-parent="#accordionExample">
                                <div className="accordion-body">
                                    <div className="container d-flex align-content-center">
                                        ...
                                        <div>
                                            <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target={`#edit-apartment-modal-${apartment.id}`}>Edit</button>
                                            <ApartmentEditModal apartment={apartment} onDelete={handleDeleteApartment} onUpdate={handleUpdateApartment} />
                                        </div>
                                    </div>
                                </div>
                            </div>
